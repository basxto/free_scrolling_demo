...
$(BUILDIR)/main.asm: src/main.c $(BUILDIR)/overworld_gb_data.c $(BUILDIR)/demo_tmap.c | $(BUILDIR)/
	$(CC) $(CFLAGS) -S -o $@ $<

$(BUILDIR)/map.asm: src/map.c src/map.h $(BUILDIR)/overworld_gb_map.c | $(BUILDIR)/
	$(CC) $(CFLAGS) -S -o $@ $<
